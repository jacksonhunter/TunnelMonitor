...
@{
    ...
    Description = 'Enterprise-grade SSH tunnel and Ollama server monitoring module with Windows service capabilities, automatic model discovery, and fast status API for PowerShell profiles. Features health monitoring, automatic recovery, and PowerAuger integration.'
    ...
    FunctionsToExport = @(
        ...
        'Install-OllamaTunnelService',     # Install Windows scheduled task with power event handling
